        ...
        <div className="mobile-header-wrapper">
          <header className="mobile-header">
            ...
            <div className="mobile-header-buttons">
              ...
              >
                <img
                  src={process.env.PUBLIC_URL + "/image/header3.png"}
                  alt="Get Started"
            ...
            <div className="header-logo-area">
              ...
              />
               ...
               <button
                 ...
                 onClick={() => console.log('Desktop Get Started clicked')}
                 aria-label="Get Started"
                 style={{
                   backgroundImage: `url(${
                     process.env.PUBLIC_URL + "/image/header3.png"
                   })`,
          ...
          <div className="full-nav-container" onClick={(e) => e.stopPropagation()}>
            {/* 상단 헤더 */}
               ...
               <div className="full-nav-header-actions">
                 <button className="full-nav-get-started">Get Started</button>
                 <button 
