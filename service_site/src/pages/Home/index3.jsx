...
import heroBgImage from '../../assets/images3/img_.png';
import wiserBgImage from '../../assets/images3/img_imagevideo.png';
import '../../components/Home3.css';

const Home3 = () => {
  const [selectedTab, setSelectedTab] = useState('01');

  // WISER 섹션 클릭 핸들러 (모바일 포함)
  const handleWiserClick = () => {
    // index3 페이지로 이동
    window.location.href = '/index3'; // 또는 Home3 컴포넌트 경로
  };
  ...
  return (
    <div className="home3-container w-full bg-global-3">
      {/* Hero Section */}
      <div 
        ...
        <div className="relative z-10 flex flex-col min-h-screen">
          ...
          <div className="flex-1 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col items-center gap-2 sm:gap-3">
              <img 
                src="/images3/img_arrow_down.svg" 
                alt="Scroll down" 
                className="w-4 h-4"
              />
      ...
      <div className="bg-global-4 py-6 sm:py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center text-lg font-medium text-global-1">
            ...
            <span 
              className="cursor-pointer hover:text-global-3 transition-colors duration-200"
              onClick={handleWiserClick}
              onTouchStart={() => {}}
              role="button"
              tabIndex={0}
              onKeyDown={(e) => {
      ...
      {/* Start WISER Section - 클릭 가능한 영역 */}
      <div 
        className="relative bg-cover bg-center bg-no-repeat cursor-pointer hover:opacity-90 transition-opacity duration-200"
              ...
              <div className="flex justify-end">
                <div className="bg-global-2 rounded px-4 sm:px-5 py-4 sm:py-5 w-full sm:w-auto max-w-2xl">
                  <div className="flex justify-between items-center gap-4 sm:gap-8">
                    ...
                    <img 
                      src="/images3/img_icon_arrow.svg" 
                      alt="Arrow" 
