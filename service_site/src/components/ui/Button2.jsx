...
const Button = ({ 
  ...
  const variants = {
    primary: 'bg-header-2 text-global-7 border border-global-7 hover:bg-global-7 hover:text-global-1',
    secondary: 'bg-global-6 text-global-1 border border-global-1 hover:bg-global-1 hover:text-global-7',
    outline: 'border border-global-1 text-global-1 hover:bg-global-1 hover:text-global-7',
  };
